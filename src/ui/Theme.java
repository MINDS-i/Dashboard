...
public class Theme{
	...
	public Theme(Context ctx){
        try{
            ...
            text             = Font.createFont(Font.TRUETYPE_FONT, new File(ttf+ctx.getResource("text_font")));
            number           = Font.createFont(Font.TRUETYPE_FONT, new File(ttf+ctx.getResource("number_font")));
