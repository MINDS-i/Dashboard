...
public class UIConfigPanel extends JPanel {
    ...
    private final JButton sketchUploadButton;
    private final JLabel lngLabel;
    private final JTextField lngField;
    private final JLabel latLabel;
    private final JTextField latField;
    private final JButton setHomeButton;
    private final JLabel fenceLabel;
     ...
     */
    private final Action toggleLocaleAction = new AbstractAction() {
        {
     ...
     */
    private final Action driverExecAction = new AbstractAction() {
        {
     ...
     */
    private final Action uploadSketchAction = new AbstractAction() {
        {
     ...
     * settings.
     */
    private final Action setHomeAction = new AbstractAction() {
        {
     ...
     * check boxes.
     */
    private final Action setSettingsAction = new AbstractAction() {
        {
