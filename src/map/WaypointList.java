...
public class WaypointList {
    ...
    //Vars
    private final List<Dot> waypoints = new LinkedList<>();
    private final List<WaypointListener> listeners = new LinkedList<>();
    ...
    public static class WaypointListener {
        ...
        public void roverMoved(WaypointListener.Source s, Dot p) {
            unusedEvent();
        }

        public void homeMoved(WaypointListener.Source s, Dot p) {
            unusedEvent();
        }

        public void changed(WaypointListener.Source s, Dot p, int index, Action a) {
            unusedEvent();
        }

        public void targetChanged(WaypointListener.Source s, int target) {
            unusedEvent();
        }

        public void loopModeSet(WaypointListener.Source s, boolean isLooped) {
            unusedEvent();
        }
