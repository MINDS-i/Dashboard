...
public class ACLIManager {
    ...
    public enum ACLICommand {
        ...
        PARSE_BOARD_INFO(Collections.singletonList(BOARD_LIST_FILE)),
        //Compiles and prepares a sketch for upload
        COMPILE_SKETCH(Collections.singletonList("compile")),
        //Uploads a sketch to the APM
        UPLOAD_SKETCH(Collections.singletonList("upload"));
